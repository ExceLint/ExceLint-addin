...
requirejs.config({
	...
	paths: {
        "linqjs": "linq",
        "ltxml": "ltxml",
        "ltxml-extensions": "ltxml-extensions",
        "openxml": "openxml",
    },
});
...
requirejs(["linqjs", "ltxml", "ltxml-extensions", "openxml"],
    function (Enumerable, Ltxml, XEnumerable, openXml) {
        ...
        var p = new XElement(W.p,
            new XElement(W.r,
                new XElement(W.t, "Hello Open XML World.  Created using node.js, with AMD (require.js).")));
        ...
        fs.writeFileSync("NodeAmdYes.docx", buffer);
