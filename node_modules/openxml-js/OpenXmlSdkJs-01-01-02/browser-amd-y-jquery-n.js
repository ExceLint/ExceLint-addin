...
(function (root) {
    define("browser-amd-y-jquery-n",
        ["linq", "ltxml", "ltxml-extensions", "openxml"],
        function (Enumerable, Ltxml, XEnumerable, openXml) {
            ...
            function createDocument() {
                ...
                var p = new XElement(W.p,
                    new XElement(W.r,
                        new XElement(W.t, "Hello Open XML World.  Created in browser, uses AMD (require.js), does not use jQuery.")));
