...
(function (root) {
    define("browser-amd-y-jquery-y",
        ["jquery", "linq", "ltxml", "ltxml-extensions", "openxml"],
            ...
            jQuery(document).ready(function () {
                ...
                function createDocument() {
                    ...
                    var p = new XElement(W.p,
                        new XElement(W.r,
                            new XElement(W.t, "Hello Open XML World.  Created in browser, uses AMD (require.js), also uses jQuery.")));
