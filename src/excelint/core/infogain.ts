export class InfoGain {
  ...
  public static to_histogram(data: Array<any>): Map<number, number> {
    ...
    const hist = arr.reduce((acc: Map<number, number>, e: number) => acc.set(e, (acc.get(e) || 0) + 1), new Map());
    return hist;
  }
}
    ...
    if (!Stencil.initialized) {
      ...
      if (Stencil.reflectStencils) {
        ...
        Stencil.stencil_topleft.splice(
          Stencil.stencil_topleft.findIndex(o => JSON.stringify(o) === JSON.stringify([1, 1])),
          1
        );
        ...
        Stencil.stencil_topright.splice(
          Stencil.stencil_topright.findIndex(o => JSON.stringify(o) === JSON.stringify([-1, 1])),
          1
        );
        ...
        Stencil.stencil_bottomleft.splice(
          Stencil.stencil_bottomleft.findIndex(o => JSON.stringify(o) === JSON.stringify([1, -1])),
          1
        );
        ...
        Stencil.stencil_bottomright.splice(
          Stencil.stencil_bottomright.findIndex(o => JSON.stringify(o) === JSON.stringify([-1, -1])),
          1
        );
